      ...
      if (data.success) {
        addToast({
          ...
          action: {
            ...
            onClick: () =>
              router.push(
                `/order/order-success?orderId=${data.data.salesOrder.name}`
              ),
          },
        });
        clearCart();
      ...
      <div className="min-h-[100dvh] pt-48 container mx-auto px-4">
        ...
        >
          ...
          <Button
            ...
            className="px-8 py-4 rounded-xl transition transform hover:scale-105"
          >
            Explore Products
          </Button>
        </Card>
            ...
            <CardContent className="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center gap-2 p-3 bg-yellow-50 dark:bg-yellow-900/20 rounded-lg">
                  <MapPin className="h-5 w-5 text-yellow-600" /> Free delivery
                  within city limits
                </div>
              </div>
              <div className="md:col-span-2">
                <Label htmlFor="notes" className="py-4">
