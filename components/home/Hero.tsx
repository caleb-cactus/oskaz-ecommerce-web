...
const Hero = () => {
  ...
  const features = [
    { icon: Shield, text: "Trusted Quality", color: "text-primary" },
    { icon: Zap, text: "Fast Delivery", color: "text-foreground" },
    { icon: Globe, text: "Global Sourcing", color: "text-primary" },
    { icon: TrendingUp, text: "Growth Focused", color: "text-foreground" },
  ];
    ...
    >
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div
            className={cn(
              "flex justify-center mb-8 motion-fade-in",
              isInView && "animate-in"
            )}
          >
            <Badge
          ...
          >
            ...
            <div className="space-y-4">
              <h2 className="text-2xl md:text-4xl lg:text-5xl font-bold leading-tight">
                ...
                <span
                  className={cn(
                    "decoration-2 underline-offset-4 decoration-primary"
                  )}
                >
                  Premium Imports
                </span>
              ...
              <p className="text-xl md:text-2xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
                Cutting-edge technology solutions and reliable imports designed
                to{" "}
                <span className="font-semibold text-foreground">
                  {" "}
                  elevate your operations
                </span>{" "}
                and drive sustainable growth in today&apos;s dynamic market.
              </p>
            </div>
          </div>
          ...
          <div
            className={cn(
              "grid grid-cols-2 md:grid-cols-4 gap-4 mb-12 max-w-2xl mx-auto stagger-children",
              isInView && "animate-in"
            )}
          >
              ...
              <div
                ...
                className={cn(
                  ...
                  isDarkMode
                    ...
                    : "bg-white/70 border-gray-200/70 hover:bg-white hover:border-primary/20 backdrop-blur-sm"
                )}
                style={{ animationDelay: `${index * 100}ms` }}
              >
                <div
                  className={cn(
                    "w-12 h-12 rounded-full flex items-center justify-center mb-3 transition-transform hover:scale-110",
          ...
          <div
            className={cn(
              "flex flex-col sm:flex-row gap-4 justify-center mb-16 motion-fade-in",
              isInView && "animate-in"
            )}
          >
            <Button
          ...
          <div className="mt-16 flex justify-center">
            <div className="flex flex-col items-center space-y-2">
              ...
              >
                <div
                  className={cn(
                    "w-1 h-3 rounded-full mt-2 animate-bounce bg-primary"
                  )}
                ></div>
              </div>
            </div>
