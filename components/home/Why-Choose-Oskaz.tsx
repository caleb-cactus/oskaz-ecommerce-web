  ...
  const features = [
    {
      ...
      description:
        "Bespoke software solutions tailored to your exact business requirements",
      emoji: "⚡",
    },
    {
      ...
      description:
        "Connect your existing systems with our smart technology ecosystem",
      emoji: "🔗",
    },
    {
      ...
      description:
        "Software that evolves with your business, from startup to enterprise",
      emoji: "📈",
    },
  ];
  ...
  const testimonials = [
    {
      ...
      content:
        "Oskaz Import delivered our Smart Board on time and in perfect condition. Their professional service and excellent communication made the process seamless. The quality of the board has greatly enhanced our classroom experience.",
      rating: 5,
    },
    {
      ...
      content:
        "Oskaz Import provided exceptional service with the delivery, installation, and after-sales support for our 100KVA Upsen UPS. Their team was professional and responsive, ensuring everything ran smoothly.",
      rating: 5,
    },
    {
      name: "Dr. Feleke Z",
      ...
      content:
        "Oskaz Import delivered our Smart Digital Signage on time and in perfect condition. Their team's professionalism and support made installation a breeze.",
      rating: 5,
    },
  ];
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <ScrollReveal variant="fadeUp" className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-lg text-muted-foreground leading-relaxed">
            Beyond hardware, Oskaz delivers tailored software solutions that
            transform how your business operates. Our development team creates
            custom applications, integrations, and digital platforms
