  ...
  const products = [
    {
      ...
      badge: "Best Seller",
      description:
        "Advanced self-service kiosk with touchscreen and payment integration",
    },
    {
      id: 2,
    ...
    },
    {
      ...
      badge: "Sale",
      description:
        "User-friendly terminal for customer engagement and information",
    },
  ];
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          <p className="text-lg text-muted-foreground leading-relaxed">
            Explore our comprehensive range of cutting-edge products designed to
            transform your business operations and enhance customer experiences.
          </p>
        </div>
        ...
        {/* CTA Section */}
        <div className={cn("text-center", isInView && "animate-fade-in")}>
          <div
            className={cn(
          ...
          >
            ...
            <p className="text-muted-foreground mb-6 max-w-md mx-auto">
              We offer custom solutions tailored to your specific business
              needs. Get in touch with our team to discuss your requirements.
            </p>
